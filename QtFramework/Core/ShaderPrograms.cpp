...
GLboolean ShaderProgram::SetUniformVariable3i(const GLchar *name, GLint parameter_1, GLint parameter_2, GLint paramater_3) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform3i(location, parameter_1, parameter_2, paramater_3);

    return GL_TRUE;
}

GLboolean ShaderProgram::SetUniformVariable4i(const GLchar *name, GLint parameter_1, GLint parameter_2, GLint paramater_3, GLint parameter_4) const
{
    if (!_program)
        return GL_FALSE;
    ...
    glUniform4i(location, parameter_1, parameter_2, paramater_3, parameter_4);
